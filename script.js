...
function showSection(section) {
    ...
    if (section === 'chatbot') {
        output.innerHTML = '<div class="command-output">Esto es un Chatbot que utiliza una arquitectura RAG para responder preguntas sobre mi perfil profesional. ¡Gracias por su interés en mi perfil!</div>';
